...
export default function ProjectCard({ title, description, imageUrl, link }: ProjectCardProps) {
  return (
    <div className="bg-white border-gray-200 border-1 border-t-0 rounded-lg ">
      ...
      <div className="bg-white p-4 rounded-lg md:p-8 h-auto md:h-auto w-full flex flex-col justify-between  border-b-0">
        <div>
