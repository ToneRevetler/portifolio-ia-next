  ...
  return <>
    <div className="flex flex-col justify-center h-full">
      <div>
        ...
        <h1 className={`${titleFont.className} pb-4 font-bold md:text-6xl tracking-wider`}>
        ...
        <h3 className="text-gray-600 text-2xl font-semibold">Full-stack <span className="text-blue-700 font-bold">Web Developer</span></h3>
      </div>
      <p className="text-gray-600 text-base md:w-2/3 pt-10">
